...
- Matt Pocock, for publishing compact engineering skills around tight debugging loops, vertical-slice TDD, domain language, and handoffs
...
- Steve Blank and the broader customer-development tradition, for making hypothesis testing and validation-first thinking legible to builders
- the wider MCP, agent tooling, and open-source workflow communities, whose public docs and patterns made it possible to describe these systems more honestly

This file is intentionally human. For the stricter record, see [UPSTREAM.md](UPSTREAM.md), [NOTICE](NOTICE), and [THIRD_PARTY_NOTICES.md](THIRD_PARTY_NOTICES.md).
