...
Use `orca list` after install for exact command availability.
...
- `orca goal`: start the closed loop from `/goal`.
...
Everything else moved out of ORCA core or should live in HVN Stack.
